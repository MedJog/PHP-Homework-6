...
<ul class=\"users-list\" id=\"navigation\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            // line 5
            echo "        <li class=\"users-li\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "getUserId", [], "method", false, false, false, 5), "html", null, true);
            echo " ";
